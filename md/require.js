...
module.exports = {
  ...
  addTag: function (data) {
    ...
    axios({
      ...
      headers: {'Authorization': '', 'Content-Type': 'application/json;charset=utf-8'},
      data: {'sortPriority': data.sortPriority, 'labelName': data.name}
    }).then(function (response) {
      deferred.resolve(response.data)
    }).catch(function (error) {
      console.log(error)
  ...
  reviseTag: function (data) {
    ...
    axios({
      ...
      headers: {'Authorization': '', 'Content-Type': 'application/json;charset=utf-8'},
      data: {'sortPriority': data.sortPriority, 'labelName': data.name, 'id': data.id}
    }).then(function (response) {
      deferred.resolve(response.data)
    }).catch(function (error) {
      console.log(error)
    ...
    //     axios({
    //         method: 'POST',
    //         url: this.u + 'api/product/obtainMemberLabel',
    //         headers: {'Authorization': '', 'Content-Type': 'application/json;charset=utf-8'},
    //         data: {}
    //     }).then(function (response) {
    //         deferred.resolve(response.data)
