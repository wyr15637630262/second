				...
				<template>
					<el-table :data="memberList" stripe style="width: 100%" v-loading.body="loading">
						...
						<el-table-column label="操作">
							<template scope="scope">
								<span style="color:#ec6a47; cursor: pointer;" @click="addTag(scope.$index, scope.row)">加标签</span>
								...
								<div class="firstAll">
									...
									<div class="firstAll-middle" style="border: 1px solid #eee;margin:16px 0;padding:10px 20px">
										...
										<div style="padding: 14px 0">
											...
											<span v-if="!hasTag">
												<a style="border: 1px solid orangered;padding: 3px 7px;display: inline-block;margin-right: 5px;">大中平台</a>
												<a style="border: 1px solid #eee;padding: 3px 7px;display: inline-block;margin-right: 5px;">大中平台</a>
												<a style="border: 1px solid #eee;padding: 3px 7px;display: inline-block;margin-right: 5px;">大中平台</a>
											</span>
